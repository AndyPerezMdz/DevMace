  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300">
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-[#233567]/5 dark:bg-[#233567]/10 rounded-full blur-3xl -z-10 transform translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <motion.h1
              ...
              className="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#233567] to-[#3a5ca9] dark:from-blue-400 dark:to-blue-600"
            >
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="group flex items-center justify-center gap-2 rounded-full px-6 py-3 h-12 w-[200px] text-lg bg-[#233567] hover:bg-[#1a284f] text-white"
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  variant="outline"
                  className="flex items-center justify-center rounded-full px-6 py-3 h-12 w-[200px] text-lg border-[#233567] text-[#233567] hover:bg-[#233567]/5 dark:border-blue-500 dark:text-blue-500 dark:hover:bg-blue-500/10"
      ...
      <section id="web-app" className="py-20 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-block px-4 py-2 bg-[#233567]/10 dark:bg-[#233567]/20 rounded-full text-[#233567] dark:text-blue-400 font-medium text-sm mb-6">
                Aplicación Web
              </div>
              ...
              >
                <motion.div variants={item} className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#233567]/10 dark:bg-[#233567]/20 flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <motion.div variants={item} className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1 text-gray-900 dark:text-white">Gestión de empleados</h3>
                    <p className="text-gray-700 dark:text-gray-400">
                ...
                <div className="p-6">
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    <div className="col-span-1">
                      <div className="h-full bg-[#233567]/10 dark:bg-[#233567]/20 rounded-lg p-4">
                    ...
                    <div className="col-span-3">
                      <div className="h-12 bg-gray-100 dark:bg-gray-800 rounded-lg mb-4 flex items-center px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative w-[280px]">
                ...
                <div className="relative mx-auto w-[280px] bg-black rounded-[2.5rem] p-2 shadow-xl z-10">
                  <div className="h-[580px] bg-white dark:bg-gray-800 rounded-[2.25rem] overflow-hidden border-[3px] border-black">
                    ...
                    <div className="p-4 h-full bg-gray-50 dark:bg-gray-900">
                      ...
                      <div className="h-32 bg-[#233567]/10 dark:bg-[#233567]/20 rounded-xl mb-6 flex items-center justify-center">
                        <QrCode className="w-20 h-20 text-[#233567] dark:text-blue-400" />
                      </div>
                      <div className="space-y-4">
                        <div className="h-12 bg-white dark:bg-gray-800 rounded-lg flex items-center px-4">
            ...
            >
              ...
              >
                <motion.div variants={item} className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1 text-gray-900 dark:text-white">Código QR personal</h3>
                    <p className="text-gray-700 dark:text-gray-400">
                ...
                <motion.div variants={item} className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1 text-gray-900 dark:text-white">Reportes mensuales</h3>
                    <p className="text-gray-700 dark:text-gray-400">
              ...
              whileTap={{ scale: 0.95 }}>
                <a
                  href="/HolidayInnExpressAplicacion.apk"
                  download
                  className="inline-flex items-center justify-center rounded-full px-8 py-3 text-lg bg-[#233567] hover:bg-[#1a284f] hover:bg-[#1a284f] text-white"
                >
